...
function PeopleInput({ currentNumberOfPeople, setNumberOfPeople }) {
    ...
    return (
        <section className={formInput.container}>
            ...
            <input className={currentNumberOfPeople <= 0 ? formInput.invalid : ""} id='people-input' type="number" min={1} placeholder='0' onChange={handlePeopleChange} value={currentNumberOfPeople} />
